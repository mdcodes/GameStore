CREATE TABLE Event (id int IDENTITY NOT NULL, Name varchar(255) NOT NULL, [Date] datetime NOT NULL, Time datetime NULL, Location varchar(255) NOT NULL, Price decimal(4, 2) NULL, Employeeid int NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Member (id int IDENTITY NOT NULL, Gender char(1) NOT NULL, Birthdate datetime NOT NULL, Email varchar(255) NOT NULL UNIQUE, MailingAddress varchar(255) NOT NULL, ShippingAddress varchar(255) NOT NULL, PhoneNumber varchar(10) NOT NULL, Categoryid int NOT NULL, Platformid int NOT NULL, PRIMARY KEY (id));
CREATE TABLE Employee (id int IDENTITY NOT NULL, Name varchar(20) NOT NULL, Surname varchar(20) NOT NULL, Phone int NOT NULL, Email varchar(255) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Login (id int IDENTITY NOT NULL, Username varchar(255) NOT NULL UNIQUE, Password varchar(255) NOT NULL, PRIMARY KEY (id));
